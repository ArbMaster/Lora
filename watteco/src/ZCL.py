...
class BytesTostrHexClass(Adapter):
	...
	def _encode(self, obj, context):
		obj_str = binascii.hexlify(obj).encode()
		return obj_str
		...
		"ByteString"           : 
			Switch(this.AttributeID, {
				...
				"NodePowerDescriptor" : Struct(
					"Size" / Byte,
			        "CurrentPowerMode" / Enum(Int8ub, ONWhenIdle = 0 , PeriodicallyON = 1, ONOnUserEvent = 2),
...
ReportParameters = BitStruct(
	"New" / Enum(Bit, Yes = 1 , No = 0),
	"Reserved" / Bit,
	"CauseRequest" / Enum(BitsInteger(2), No = 0, Short = 1, Long = 2),
...
DataCauseN2 = Switch(
	this._._.AttributeType, {
		...
		"UInt8Enum"            : Int8ub,
		"SinglePrecision"      : Float32b,
		"ByteString"           : 	Switch(this._._.AttributeID, {
										"CurrentMetering" : 
											Switch(this.FieldIndex, {
												0 : Int24sb,
												1 : Int24sb,
...
CauseConfiguration =  Struct(
	"CriteriaSlotDescriptor" / CriteriaSlotDescriptor,
	Embedded ( 	If ( ((this._._.AttributeType == "CharString") |
					   (this._._.AttributeType  == "ByteString") |
					   (this._._.AttributeType  == "LongByteString") |
					   (this._._.AttributeType  == "StructOrderedSequence")), Struct("FieldIndex" / Int8ub)
					   )
				),
	"Value"/DataCauseN2,
	"Gap"/ DataCauseN2,
